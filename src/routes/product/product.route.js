...
// seller
router.post('/', seller(), validator(schema.createProductSchema), controller.createProductPost);
router.put('/', seller(), validator(schema.updateProductSchema), controller.appendProductDetail);
